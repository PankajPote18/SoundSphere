...
const Sidebar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 md:top-0 w-full md:w-16 h-16 md:h-full bg-bg-dark flex flex-row md:flex-col items-center justify-around md:justify-center py-0 md:py-6 z-50 border-t md:border-t-0 md:border-r border-white/5 shadow-2xl">
      <div className="flex flex-row md:flex-col items-center justify-center space-x-0 md:space-y-8 w-full">
